<!-- 来源摘要元数据（原文件自带 frontmatter，故来源信息以注释保存）
title: Subagent 定义：Implementation Agent
source: GitHub 仓库 luongnv89/claude-howto（zh/04-subagents/implementation-agent.md）
